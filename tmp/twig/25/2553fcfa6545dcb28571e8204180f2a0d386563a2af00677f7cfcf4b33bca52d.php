...
class __TwigTemplate_0038daf34529e54463c9a63587286f4cdf02726a7d80132b6829c82910660978 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Query results operations");
  ...
  ";
        ...
        if ( !Twig\Extension\CoreExtension::testEmpty(($context["operations"] ?? null))) {
            // line 269
            yield "    ";
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["operations"] ?? null), "has_print_link", [], "any", false, false, false, 269)) {
                // line 270
    ...
    ";
            // line 280
            if ( !CoreExtension::getAttribute($this->env, $this->source, ($context["operations"] ?? null), "has_procedure", [], "any", false, false, false, 280)) {
                // line 281
                yield "      ";
                if (CoreExtension::getAttribute($this->env, $this->source, ($context["operations"] ?? null), "has_export_link", [], "any", false, false, false, 281)) {
                    // line 282
                    yield "        ";
                    yield PhpMyAdmin\Html\Generator::linkOrButton(PhpMyAdmin\Url::getFromRoute("/table/export"), CoreExtension::getAttribute($this->env, $this->source,                     // line 284
($context["operations"] ?? null), "url_params", [], "any", false, false, false, 284), PhpMyAdmin\Html\Generator::getIcon("b_tblexport", _gettext("Export"), true), ["class" => "btn"]);
                    // line 287
                    yield "

        ";
                    // line 289
                    yield PhpMyAdmin\Html\Generator::linkOrButton(PhpMyAdmin\Url::getFromRoute("/table/chart"), CoreExtension::getAttribute($this->env, $this->source,                     // line 291
($context["operations"] ?? null), "url_params", [], "any", false, false, false, 291), PhpMyAdmin\Html\Generator::getIcon("b_chart", _gettext("Display chart"), true), ["class" => "btn"]);
                    // line 294
                    yield "

        ";
                    // line 296
                    if (CoreExtension::getAttribute($this->env, $this->source, ($context["operations"] ?? null), "has_geometry", [], "any", false, false, false, 296)) {
                        // line 297
                        yield "          ";
                        yield PhpMyAdmin\Html\Generator::linkOrButton(PhpMyAdmin\Url::getFromRoute("/table/gis-visualization"), CoreExtension::getAttribute($this->env, $this->source,                         // line 299
($context["operations"] ?? null), "url_params", [], "any", false, false, false, 299), PhpMyAdmin\Html\Generator::getIcon("b_globe", _gettext("Visualize GIS data"), true), ["class" => "btn"]);
                        // line 302
                        yield "
        ";
                    }
      ...
      <span>
        ";
                // line 307
                yield PhpMyAdmin\Html\Generator::linkOrButton(PhpMyAdmin\Url::getFromRoute("/view/create"), ["db" =>                 // line 309
...
";
        // line 317
        if (( !Twig\Extension\CoreExtension::testEmpty(($context["operations"] ?? null)) &&  !CoreExtension::getAttribute($this->env, $this->source, ($context["operations"] ?? null), "has_procedure", [], "any", false, false, false, 317))) {
            // line 318
