...
class __TwigTemplate_508ec253596edbd8918ea1f4e111780b6dd7a9b51962ea78c59490ed65221125 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Effective");
            ...
            yield "
                ";
            // line 43
            if (((isset($context["tot_size"]) || array_key_exists("tot_size", $context)) && (0 === CoreExtension::compare(($context["mergetable"] ?? null), false)))) {
                // line 44
                yield "                    <tr>
                        <th class=\"name\">";
yield _gettext("Total");
            ...
            // line 53
            yield "                ";
            if ((((isset($context["free_size"]) || array_key_exists("free_size", $context)) && ((((0 === CoreExtension::compare(            // line 54
...
";
    ...
    {
        return new Source("", "table/structure/display_table_stats.twig", "O:\\panzuowen\\arbitrary\\phpmyadmin522\\templates\\table\\structure\\display_table_stats.twig");
    }
}
